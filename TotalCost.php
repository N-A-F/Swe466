...
<body class="u-body">
  ...
  <section class="u-align-left u-clearfix u-image u-section-1" id="sec-0d41" style="background-color: #DBE2EF;">
    <div class="u-align-left u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
      <div class="u-expanded-width u-table u-table-responsive u-table-1" style="margin-bottom:15px">
        <table style="margin-top: -65px;" class="u-table-entity table table-striped table-hover table table-dark table-hover" style="margin-bottom:15px">
          <colgroup>
            <col width="20%">
            <col width="20%">
            <col width="20%">
          ...
          <tbody class="u-table-body">
            ...
            ?>
              ...
              <tr style="height: 75px;">
                ...
                <td class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-7"></td>
                <td style="text-align: center;" class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-8"></td>
                <td style="text-align: center;" class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-9"></td>
                <td style="text-align: center;" class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-10"></td>
                <td class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-10"></td>
                <td style="text-align: center;" class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-10">
                  <h6>
                    <?php echo $totalCost; ?>
                  </h6>
