                ...
                <table class="u-table-entity" style="margin-bottom:15px">
                    ...
                    <thead class="u-palette-4-base u-table-header u-table-header-1">
                        <tr>
                            ...
                            <th class="  u-palette-1-base u-table-cell u-table-cell-6"> Resource Name </th>
                        </tr>
                    </thead>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($rows = mysqli_fetch_assoc($result)) {
                                ...
                                while ($rows_rtt = mysqli_fetch_assoc($result_resToTask)) {
                                    //print_r($rows_rtt);
                                    array_push($r2, $rows_rtt['resName']);
                                    array_push($r_n, $rows_rtt['taskName']);
                                }
                  ...
                  //     <td style="text-align: center;"class="u-border-1 u-border-grey-30 -1 u-first-column u-table-cell u-table-cell-6"><?php echo $count ?></td>
                            ...
                            <td style="text-align: center;"
                                ...
                                <?php
                                        ...
                                        if (mysqli_num_rows($result_res) > 0) {
                                            //$rows_res=mysqli_fetch_assoc($result_res)
                                            //foreach($rows_res as $value => $key){
                                            // while($rows_res=mysqli_fetch_assoc($result_res)){
                                            $i = 1;
                                            foreach ($r2 as $vlaue) {


                                                echo "<p style='width:250px'>$i-$vlaue</p>";
                                                $i++;
                                            }
                                        }
                                ...
                                <!-- <input type="text" name="Name" style="display: none;" value="<? //=$rows['Name']
                                                                                                            ?>">
                          <input style="margin-top: 5px;margin-bottom: -1px;"type="submit" name="submit" 
                          class="u-border-none u-button-style -3 u-hover-palette-1-dark-1 " value="Add"> -->
                                <!-- </form>      -->
