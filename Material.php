        ...
        <div
            ...
            <form action="NewMaterial.php" method="post">
                <div class="u-expanded-width u-table u-table-responsive u-table-1" style="margin-top:50px">
                    <table class="u-table-entity table table-striped table-hover" style="margin-bottom:15px;">
                        <colgroup>
                            <col width="20%">
                            <col width="20%">
                            <col width="20%">
              ...
              ?>
                ...
                ?>
                            <tr style="height: 75px;">
                                <td class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-7">
                                    <input type="text" name="Resource" placeholder="Name" required>
                                </td>
                                <td class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-7">
                                    <select name="Type" id="Type" onchange="visacatOnchange()" required>
                                ...
                                <td style="text-align: center;"
                                    ...
                                    <div id="textboxdiv2" style="display:none;">
                                        <input type="text" name="Max" id="Max" placeholder="100$"
                                ...
                                <td style="text-align: center;"
                                    ...
                                    <div id="textboxdiv3" style="display:none;">
                                        <input type="text" name="Rate" id="Rate" placeholder="Price$"
                                            style="width:70px">
                                    </div>
                                </td>
                                <td style="text-align: center;"
                                    ...
                                    <div id="textboxdiv4" style="display:none;">
                                        <input type="text" name="Ovt" id="Ovt" placeholder="OVT$" style="width:70px">
                                    </div>
                                </td>
                      ...
                      <div id="textboxdiv5" style="display:none;">
                        <input type="text" name="Cost" id="Cost" placeholder="Price$"style="width:70px">
                      </div> 
                    </td> -->
                            </tr>
                            <?php
              } //if there not tasks in database
              else {
              ?>
                            <tr style="height: 75px;">
                                <td class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-7">
                                ...
                                <td style="text-align: center;"
                                    class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-9">
                                    <div id="textboxdiv2" style="display:none;">
                                        <input type="text" name="Max" id="Max" value="100"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
                                    </div>
                                </td>
                                <td style="text-align: center;"
                                ...
                                <td style="text-align: center;"
                                    class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-10">
                                    <div id="textboxdiv4" style="display:none;">
                                        <input type="text" name="Ovt" id="Ovt" placeholder="Price$">
                                    </div>
                                </td>
                                <!-- <td style="text-align: center;"class="u-border-1 u-border-grey-30 -2 u-table-cell u-table-cell-10">
                    <div id="textboxdiv5" style="display:none;">
                      <input type="text" name="Cost" id="Cost" placeholder="Price$">
                    </div> 
                  </td> -->
                            </tr>
                            <?php
              ...
              ?>
                ...
                <input type="submit" name="submit"
                    class="u-border-none u-btn u-button-style -3 u-hover-palette-1-dark-1 u-btn-1" value="Submit"
