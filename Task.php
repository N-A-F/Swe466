            ...
            <form action="NewTask.php" method="post">
              ...
              ?>
                            <tr style="height: 75px;">
                                <td style="text-align: center;"
                                    class="u-border-1 u-border-grey-30 u-first-column u-table-cell u-table-cell-6">
                                    <?php echo $count ?></td>
                                <td class="u-border-1 u-border-grey-30  u-table-cell u-table-cell-7">
                                    <?php echo $rows['Name']; ?>
                                </td>
                                <td style="text-align: center;"
                                    class="u-border-1 u-border-grey-30  u-table-cell u-table-cell-8">
                                    <?php echo $differenceInDay; ?>
                                </td>
                                <td style="text-align: center;"
                                    class="u-border-1 u-border-grey-30  u-table-cell u-table-cell-9">
                                    <?php echo $rows['Start']; ?>
                                </td>
                                <td style="text-align: center;"
                                    class="u-border-1 u-border-grey-30  u-table-cell u-table-cell-10">
                                    <?php echo $rows['End']; ?>
                                </td>
                            </tr>
                            <?php
              ...
              ?>
                ...
                <input type="submit" name="submit"
                    class="u-border-none u-btn u-button-style  u-hover-palette-1-dark-1 u-btn-1" value="Submit"
